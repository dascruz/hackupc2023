...
namespace ChatGPTWrapper {
    ...
    public class UnityCustomEvent : UnityEvent<CustomRes>{}
    ...
    public class ChatGPTConversation : MonoBehaviour
    {
        ...
        [HideInInspector] public CustomRes lastPrompt;
        ...
        public UnityCustomEvent customResponse = new UnityCustomEvent();
        ...
        private void OnEnable()
        {
            ...
            switch (_model) {
                ...
                case Model.Custom:
                    _chat = new Chat(_initialPrompt);
                    _uri = "https://hack-upc-backend-api.vercel.app/";
                    _selectedModel = "gpt-3.5-turbo";
                    break;
            }
        }
        ...
        public void SendToChatGPT(string message) {
            ...
            switch (_model) {
                case Model.Custom:
                    StartCoroutine(requests.CustomPostReq(_uri, message, ResolveCustom));
                    break;
                case Model.ChatGPT when _useProxy: {
        ...
        private void ResolveCustom(string res) {
            _lastChatGPTMsg = res;
            _chat.AppendMessage(Chat.Speaker.User, _lastUserMsg);
            _chat.AppendMessage(Chat.Speaker.ChatGPT, _lastChatGPTMsg);
            chatGPTResponse.Invoke(_lastChatGPTMsg);
